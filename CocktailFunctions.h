...
//================================================================================================================
const Int_t nCentralities               = 17;
const Int_t nParticles                  = 28;
const Int_t nMethods                    = 13;
TString fCollSys[3]                     = {"pp", "pPb", "PbPb"};
TString fEnergy[6]                      = {"0.9TeV", "2.76TeV", "5TeV", "7TeV", "8TeV", "13TeV"};
...
TString fEnergyLatexPP[6]               = {"#sqrt{s} = 900 GeV", "#sqrt{s} = 2.76 TeV", "#sqrt{s} = 5 TeV", "#sqrt{s} = 7 TeV", "#sqrt{s} = 8 TeV", "#sqrt{s} = 13 TeV"};
TString fCentrality[nCentralities]      = {"MB", "0005",   "0510",   "0010",   "1020",   "0020",   "2040",   "2050",   "4060",   "6080",   "8090",   "80100",   "2030",   "3040", "2060", "60100", "NSD"};
TString fCentralityLatex[nCentralities] = {"MB", "0-5%",   "5-10%",  "0-10%",  "10-20%", "0-20%",  "20-40%", "20-50%", "40-60%", "60-80%", "80-90%", "80-100%", "20-30%", "30-40%", "20-60%", "60-100%", "NSD"};
TString fCentralityOpt2[nCentralities]  = {"MB", "00to05", "05to10", "00to10", "10to20", "00to20", "20to40", "20to50", "40to60", "60to80", "80to90", "80to100", "20to30", "30to40", "20to60", "60to100", "MB"};
TString fCentralityOpt3[nCentralities]  = {"MB", "0to5",   "5to10",  "0to10",  "10to20", "00to20", "20to40", "20to50", "40to60", "60to80", "80to90", "80to100", "20to30", "30to40", "20to60", "60to100", "MB"};
TString fCentralityOpt4[nCentralities]  = {"MB", "05",     "510",    "010",    "1020",   "020",    "2040",   "2050",   "4060",   "6080",   "8090",   "80100",   "2030",   "3040", "2060", "60100", "NSD"};
TString fMethod[nMethods]               = {"", "Comb", "PCM", "PHOS", "EMCal", "PCMPHOS", "PCMEMCal", "EMCalMerged", "lowPt", "highPt", "Dalitz", "PCMPass2","MCParam"};
TString fParticle[nParticles]           = {"NPion", "Eta", "Omega", "EtaPrime", "GammaDir", "CPion", "CKaon", "Proton", "CHadron", "Phi", "NKaonStar",
                                           ...
                                           "DZero", "DPlus", "DStarPlus", "DSPlus", "CSigmaStar", "NXiStar"};
...
Bool_t fIsMeson[nParticles]             = { kTRUE, kTRUE, kTRUE, kTRUE, kFALSE, kTRUE, kTRUE, kFALSE, kFALSE,
                                            ...
                                            kFALSE, kFALSE, kFALSE, kTRUE, kTRUE, kTRUE, kTRUE, kTRUE, kFALSE, kFALSE};
...
Int_t fParticlePDG[nParticles]          = { 111, 221, 223, 331, 22, 211, 321, 2212, 211,
                                            333, 313, 113, 213, 2114, 1114, 310, 3122, 3212,
                                            3222, 3334, 3312, 443, 421, 411, 413, 431, 3224, 3214 };
Color_t paint[28]                       = { kBlue+1, kGreen+3, kRed+1, kAzure+4, kSpring+4, kPink+8, kBlue-4, kTeal-6, kYellow+3, kOrange+2, kViolet+1,
                                            kCyan+1, kRed-3, kBlue+2, kTeal+3, kOrange+4, kPink-8, kViolet-5, kAzure+1, kSpring-7, kBlack, kGray+2,
                                            kAzure-7, kTeal+1, kViolet-7, kRed-7, kBlue+1, kGreen+3 };
...
Style_t lineStyle[10]                   = { 1,  5,  6,  7,  8,
                                            1,  5,  6,  7,  8};
Color_t lineColor[10]                   = { kBlack,  kGray+2,  kGray+1, kBlue-4,  kBlue-6,
                                            kRed-6,  kRed-4,  kGreen-6,  kGreen-4,  kAzure-7};
