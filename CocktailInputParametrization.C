...
void CocktailInputParametrization(  TString inputFileName                       = "CocktailInputPP.root",
            ...
            for (Int_t methodIter = 0; methodIter < nMethods; methodIter++) {
                ...
                if ( inputList[listIter]->FindObject(Form("%s%sStat", fParticle[particleIter].Data(), fMethod[methodIter].Data())) && inputList[listIter]->FindObject(Form("%s%sSys", fParticle[particleIter].Data(), fMethod[methodIter].Data())) ) {
                    ...
                    if (doPtDepSysErrFactorPlotsSep) {
                        ...
                        ProducePlotPtDepSystFactors(tempSpecFactorLinShiftA,tempSpecFactorLinShiftB,NULL,NULL,fCollSysTemp,fEnergyTemp,fCentralityTemp,fParticle[particleIter],fMethod[methodIter],suffix,nameFactorPlot);

                        nameFactorPlot                      = Form("spectra_%s%s_ptDepFactorPol2",fParticle[particleIter].Data(),fMethod[methodIter].Data());
                        ProducePlotPtDepSystFactors(NULL,NULL,tempSpecFactorPol2ShiftA,tempSpecFactorPol2ShiftB,fCollSysTemp,fEnergyTemp,fCentralityTemp,fParticle[particleIter],fMethod[methodIter],suffix,nameFactorPlot);

                    } else {

                        nameFactorPlot                      = Form("spectra_%s%s_ptDepFactorLinPol2",fParticle[particleIter].Data(),fMethod[methodIter].Data());
                        ProducePlotPtDepSystFactors(tempSpecFactorLinShiftA,tempSpecFactorLinShiftB,tempSpecFactorPol2ShiftA,tempSpecFactorPol2ShiftB,fCollSysTemp,fEnergyTemp,fCentralityTemp,fParticle[particleIter],fMethod[methodIter],suffix,nameFactorPlot);
                    }
                    ...
                    if (doSpectra && type.CompareTo("")!=0) {
                        ...
                        // fit spectra
                        tempSpecFit                         = FitObject(tempSpecStat,Form("%s_Fit",tempSpecStat->GetName()),fParticle[particleIter],fCentralityTemp,fMethod[methodIter],type);
                        if (tempSpecStatPtConstShiftUp)
                            tempSpecFitPtConstUp            = FitObject(tempSpecStatPtConstShiftUp,Form("%s_Fit",tempSpecStatPtConstShiftUp->GetName()),fParticle[particleIter],fCentralityTemp,fMethod[methodIter],type);
                        if (tempSpecStatPtConstShiftDown)
                            tempSpecFitPtConstDown          = FitObject(tempSpecStatPtConstShiftDown,Form("%s_Fit",tempSpecStatPtConstShiftDown->GetName()),fParticle[particleIter],fCentralityTemp,fMethod[methodIter],type);
                        if (tempSpecStatPtLinShiftA)
                            tempSpecFitPtLinA               = FitObject(tempSpecStatPtLinShiftA,Form("%s_Fit",tempSpecStatPtLinShiftA->GetName()),fParticle[particleIter],fCentralityTemp,fMethod[methodIter],type);
                        if (tempSpecStatPtLinShiftB)
                            tempSpecFitPtLinB               = FitObject(tempSpecStatPtLinShiftB,Form("%s_Fit",tempSpecStatPtLinShiftB->GetName()),fParticle[particleIter],fCentralityTemp,fMethod[methodIter],type);
                        if (tempSpecStatPtPol2ShiftA)
                            tempSpecFitPtPol2A              = FitObject(tempSpecStatPtPol2ShiftA,Form("%s_Fit",tempSpecStatPtPol2ShiftA->GetName()),fParticle[particleIter],fCentralityTemp,fMethod[methodIter],type);
                        if (tempSpecStatPtPol2ShiftB)
                            tempSpecFitPtPol2B              = FitObject(tempSpecStatPtPol2ShiftB,Form("%s_Fit",tempSpecStatPtPol2ShiftB->GetName()),fParticle[particleIter],fCentralityTemp,fMethod[methodIter],type);
                        ...
                        if (tempStatClass.Contains("TH1")) {
                            ...
                            namePlot                            = Form("spectra_%s%s_ptPol2",fParticle[particleIter].Data(),fMethod[methodIter].Data());
                            ProducePlotWithRatioToFit((TGraphErrors*)tempSpecStat,(TGraphErrors*)tempSpecStatPtPol2ShiftA,(TGraphErrors*)tempSpecStatPtPol2ShiftB,tempSpecFit,tempSpecFitPtPol2A,tempSpecFitPtPol2B,tempSpecStatRatioToFit,tempSpecStatPtPol2ShiftARatioToFit,tempSpecStatPtPol2ShiftBRatioToFit,fCollSysTemp,fEnergyTemp,fCentralityTemp,fParticle[particleIter],fMethod[methodIter],type,suffix,"","",namePlot,xMinFit,xMaxFit,kFALSE);
                            ...
                            namePlot                            = Form("spectra_%s%s_ptPol2",fParticle[particleIter].Data(),fMethod[methodIter].Data());
                            ProducePlotWithRatioToFit((TGraphAsymmErrors*)tempSpecStat,(TGraphAsymmErrors*)tempSpecStatPtPol2ShiftA,(TGraphAsymmErrors*)tempSpecStatPtPol2ShiftB,tempSpecFit,tempSpecFitPtPol2A,tempSpecFitPtPol2B,tempSpecStatRatioToFit,tempSpecStatPtPol2ShiftARatioToFit,tempSpecStatPtPol2ShiftBRatioToFit,fCollSysTemp,fEnergyTemp,fCentralityTemp,fParticle[particleIter],fMethod[methodIter],type,suffix,"","",namePlot,xMinFit,xMaxFit,kFALSE);
                        }
                        ...
                        if (doParamRatioPlotsSep) {
                            ...
                            ProducePlotParamRatios(tempSpecFit,tempSpecFitPtConstUp,tempSpecFitPtConstDown,NULL,NULL,NULL,NULL,fCollSysTemp,fEnergyTemp,fCentralityTemp,fParticle[particleIter],fMethod[methodIter],suffix,nameParamRatioPlot);

                            nameParamRatioPlot                 = Form("spectra_%s%s_paramLinToCentral",fParticle[particleIter].Data(),fMethod[methodIter].Data());
                            ProducePlotParamRatios(tempSpecFit,NULL,NULL,tempSpecFitPtLinA,tempSpecFitPtLinB,NULL,NULL,fCollSysTemp,fEnergyTemp,fCentralityTemp,fParticle[particleIter],fMethod[methodIter],suffix,nameParamRatioPlot);

                            nameParamRatioPlot                 = Form("spectra_%s%s_paramPol2ToCentral",fParticle[particleIter].Data(),fMethod[methodIter].Data());
                            ProducePlotParamRatios(tempSpecFit,NULL,NULL,NULL,NULL,tempSpecFitPtPol2A,tempSpecFitPtPol2B,fCollSysTemp,fEnergyTemp,fCentralityTemp,fParticle[particleIter],fMethod[methodIter],suffix,nameParamRatioPlot);

                        } else {

                            nameParamRatioPlot                 = Form("spectra_%s%s_paramAllToCentral",fParticle[particleIter].Data(),fMethod[methodIter].Data());
                            ProducePlotParamRatios(tempSpecFit,tempSpecFitPtConstUp,tempSpecFitPtConstDown,tempSpecFitPtLinA,tempSpecFitPtLinB,tempSpecFitPtPol2A,tempSpecFitPtPol2B,fCollSysTemp,fEnergyTemp,fCentralityTemp,fParticle[particleIter],fMethod[methodIter],suffix,nameParamRatioPlot);
                        }
                    }
                }
                ...
                for (Int_t i = 0; i < nParticles; i++) {
                    if ( inputList[listIter]->FindObject(Form("%sTo%s%sStat", fParticle[particleIter].Data(), fParticle[i].Data(), fMethod[methodIter].Data())) && inputList[listIter]->FindObject(Form("%sTo%s%sSys", fParticle[particleIter].Data(), fParticle[i].Data(), fMethod[methodIter].Data())) ) {
                        ...
                        if (doPtDepSysErrFactorPlotsSep) {
                            ...
                            ProducePlotPtDepSystFactors(tempRatioFactorLinShiftA,tempRatioFactorLinShiftB,NULL,NULL,fCollSysTemp,fEnergyTemp,fCentralityTemp,fParticle[particleIter],fMethod[methodIter],suffix,nameRatioFactorPlot);
                            ...
                            ProducePlotPtDepSystFactors(NULL,NULL,tempRatioFactorPol2ShiftA,tempRatioFactorPol2ShiftB,fCollSysTemp,fEnergyTemp,fCentralityTemp,fParticle[particleIter],fMethod[methodIter],suffix,nameRatioFactorPlot);
                            ...
                            ProducePlotPtDepSystFactors(tempRatioFactorLinShiftA,tempRatioFactorLinShiftB,tempRatioFactorPol2ShiftA,tempRatioFactorPol2ShiftB,fCollSysTemp,fEnergyTemp,fCentralityTemp,fParticle[particleIter],fMethod[methodIter],suffix,nameRatioFactorPlot);
                        }
                        ...
                        if (doRatios && typeRatio.CompareTo("")!=0) {
                            ...
                            // fit ratios
                            tempRatioFit                            = FitRatio(tempRatioStat,Form("%s_Fit",tempRatioStat->GetName()),fParticle[particleIter],fParticle[i],fCentralityTemp,fMethod[methodIter],typeRatio);
                            if (tempRatioStatPtConstShiftUp)
                                tempRatioFitPtConstUp               = FitRatio(tempRatioStatPtConstShiftUp,Form("%s_Fit",tempRatioStatPtConstShiftUp->GetName()),fParticle[particleIter],fParticle[i],fCentralityTemp,fMethod[methodIter],typeRatio);
                            if (tempRatioStatPtConstShiftDown)
                                tempRatioFitPtConstDown             = FitRatio(tempRatioStatPtConstShiftDown,Form("%s_Fit",tempRatioStatPtConstShiftDown->GetName()),fParticle[particleIter],fParticle[i],fCentralityTemp,fMethod[methodIter],typeRatio);
                            if (tempRatioStatPtLinShiftA)
                                tempRatioFitPtLinA                  = FitRatio(tempRatioStatPtLinShiftA,Form("%s_Fit",tempRatioStatPtLinShiftA->GetName()),fParticle[particleIter],fParticle[i],fCentralityTemp,fMethod[methodIter],typeRatio);
                            if (tempRatioStatPtLinShiftB)
                                tempRatioFitPtLinB                  = FitRatio(tempRatioStatPtLinShiftB,Form("%s_Fit",tempRatioStatPtLinShiftB->GetName()),fParticle[particleIter],fParticle[i],fCentralityTemp,fMethod[methodIter],typeRatio);
                            if (tempRatioStatPtPol2ShiftA)
                                tempRatioFitPtPol2A                 = FitRatio(tempRatioStatPtPol2ShiftA,Form("%s_Fit",tempRatioStatPtPol2ShiftA->GetName()),fParticle[particleIter],fParticle[i],fCentralityTemp,fMethod[methodIter],typeRatio);
                            if (tempRatioStatPtPol2ShiftB)
                                tempRatioFitPtPol2B                 = FitRatio(tempRatioStatPtPol2ShiftB,Form("%s_Fit",tempRatioStatPtPol2ShiftB->GetName()),fParticle[particleIter],fParticle[i],fCentralityTemp,fMethod[methodIter],typeRatio);
                            ...
                            if (doParamRatioPlotsSep) {
                                ...
                                ProducePlotParamRatios(tempRatioFit,tempRatioFitPtConstUp,tempRatioFitPtConstDown,NULL,NULL,NULL,NULL,fCollSysTemp,fEnergyTemp,fCentralityTemp,fParticle[particleIter],fMethod[methodIter],suffix,nameRatioParamRatioPlot);
                                ...
                                ProducePlotParamRatios(tempRatioFit,NULL,NULL,tempRatioFitPtLinA,tempRatioFitPtLinB,NULL,NULL,fCollSysTemp,fEnergyTemp,fCentralityTemp,fParticle[particleIter],fMethod[methodIter],suffix,nameRatioParamRatioPlot);
                                ...
                                ProducePlotParamRatios(tempRatioFit,NULL,NULL,NULL,NULL,tempRatioFitPtPol2A,tempRatioFitPtPol2B,fCollSysTemp,fEnergyTemp,fCentralityTemp,fParticle[particleIter],fMethod[methodIter],suffix,nameRatioParamRatioPlot);
                                ...
                                ProducePlotParamRatios(tempRatioFit,tempRatioFitPtConstUp,tempRatioFitPtConstDown,tempRatioFitPtLinA,tempRatioFitPtLinB,tempRatioFitPtPol2A,tempRatioFitPtPol2B,fCollSysTemp,fEnergyTemp,fCentralityTemp,fParticle[particleIter],fMethod[methodIter],suffix,nameRatioParamRatioPlot);
                            }
                        }
                    }
                }
    ...
    for (Int_t i=0; i<listIter; i++) {
        for(Int_t j=0; j<9; j++) {
            if (outputList[i]) WriteParametrizationsFile(outputList[i], inputList[i], uniqueName, j, suffix);
        }
    }
